...
@Component
public class SszClientInterceptor implements ClientInterceptor {

    private final SoapMessageService soapMessageService;

    @Autowired
    public SszClientInterceptor(SoapMessageService soapMessageService) {
    ...
    public boolean handleRequest(MessageContext messageContext) {
        try {
            ...
            soapMessageService.formSszRequestMessage(soapMessage);
