...
@Component
public class AkiNeoClientInterceptor implements ClientInterceptor {

    private final SoapMessageService soapMessageService;

    @Autowired
    public AkiNeoClientInterceptor(SoapMessageService soapMessageService) {
    ...
    public boolean handleRequest(MessageContext messageContext) {
        try {
            ...
            soapMessageService.formAkiNeoRequestMessage(soapMessage);
