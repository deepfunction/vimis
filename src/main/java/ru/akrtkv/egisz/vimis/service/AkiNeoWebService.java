...
import ru.akrtkv.egisz.vimis.interceptor.AkiNeoClientInterceptor;
import ru.akrtkv.egisz.vimis.utils.ObjectCreator;

import javax.annotation.PostConstruct;

@Service
public class AkiNeoWebService extends WebServiceGatewaySupport {

    private final AkiNeoClientInterceptor interceptor;
    ...
    @Autowired
    public AkiNeoWebService(AkiNeoClientInterceptor interceptor, ObjectCreator objectCreator) {
