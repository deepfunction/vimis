...
import ru.akrtkv.egisz.vimis.interceptor.SszClientInterceptor;
import ru.akrtkv.egisz.vimis.utils.ObjectCreator;

import javax.annotation.PostConstruct;

@Service
public class SszWebService extends WebServiceGatewaySupport {

    private final SszClientInterceptor interceptor;
    ...
    @Autowired
    public SszWebService(SszClientInterceptor interceptor, ObjectCreator objectCreator) {
        this.interceptor = interceptor;
        this.objectCreator = objectCreator;
    }

    public SszWebService(WebServiceMessageFactory messageFactory, SszClientInterceptor interceptor, ObjectCreator objectCreator) {
